...
export const Footer = () => {
  return (
    <footer className="bg-bizblue-50 border-t border-border/40">
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Transform business documents into actionable insights with AI-powered analysis.
            </p>
          </div>
        ...
        <div className="mt-12 border-t border-border pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} BizWhisper Insights. All rights reserved.
          </p>
